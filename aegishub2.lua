...
if not isfolder("AegisHUB") then
    makefolder("AegisHUB")
end
if not isfolder("AegisHUB/Config") then
    makefolder("AegisHUB/Config")
end
...
local ConfigFile = "AegisHUB/Config/AegisHUB_" .. gameName .. ".json"
...
local Icons = {
    ...
    whatsapp  = "rbxassetid://91177769678545",
}
                        ...
                        dragConn = UserInputService.InputChanged:Connect(function(I)
                            if Dragging and (I.UserInputType == Enum.UserInputType.MouseMovement or I.UserInputType == Enum.UserInputType.Touch) then
                                local SizeScale = math.clamp(
                                    (I.Position.X - SliderFrame.AbsolutePosition.X) / SliderFrame.AbsoluteSize.X,
                                    0,
                                    1
                                )
    ...
    local function CustomSize(object)
        ...
        changesizeobject.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                ...
                if sizeConn then sizeConn:Disconnect() sizeConn = nil end
                sizeConn = UserInputService.InputChanged:Connect(function(i)
                    if i == DragInput and Dragging then
                        UpdateSize(i)
                    end
                end)
...
function CircleClick(Button, X, Y)
    spawn(function()
        ...
        Circle.ImageColor3 = GuiConfig.SubTextColor
        Circle.ImageTransparency = 0.8999999761581421
        Circle.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
...
local Sirenx = {}
function Sirenx:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "AegisHUB"
    NotifyConfig.Description = NotifyConfig.Description or "Notification"
    NotifyConfig.Content = NotifyConfig.Content or "Content"
    NotifyConfig.Color = NotifyConfig.Color or (rawget(_G,"SirenxThemeColor") or GuiConfig.Color)
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
            NotifyLayout.BackgroundTransparency = 0.9990000128746033
            NotifyLayout.BorderColor3 = GuiConfig.BgColor
        ...
        NotifyFrame.BackgroundColor3 = (rawget(_G,"SirenxThemeBg") or GuiConfig.BgColor)
        NotifyFrame.BorderColor3 = GuiConfig.BgColor
        ...
        NotifyFrameReal.BackgroundColor3 = (rawget(_G,"SirenxThemeBg") or GuiConfig.BgColor)
        NotifyFrameReal.BorderColor3 = GuiConfig.BgColor
        ...
        Top.BackgroundColor3 = (rawget(_G,"SirenxThemeBg") or GuiConfig.BgColor)
        Top.BackgroundTransparency = 0.9990000128746033
        Top.BorderColor3 = GuiConfig.BgColor
        ...
        TextLabel.TextColor3 = (rawget(_G,"SirenxThemeText") or GuiConfig.TextColor)
        TextLabel.TextSize = 14
        TextLabel.TextXAlignment = Enum.TextXAlignment.Left
        TextLabel.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
        TextLabel.BackgroundTransparency = 0.9990000128746033
        TextLabel.BorderColor3 = GuiConfig.BgColor
        ...
        TextLabel1.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
        TextLabel1.BackgroundTransparency = 0.9990000128746033
        TextLabel1.BorderColor3 = GuiConfig.BgColor
        ...
        Close.Text = ""
        Close.TextColor3 = GuiConfig.BgColor
        Close.TextSize = 14
        Close.AnchorPoint = Vector2.new(1, 0.5)
        Close.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
        Close.BackgroundTransparency = 0.9990000128746033
        Close.BorderColor3 = GuiConfig.BgColor
        ...
        ImageLabel.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
        ImageLabel.BackgroundTransparency = 0.9990000128746033
        ImageLabel.BorderColor3 = GuiConfig.BgColor
        ...
        TextLabel2.TextColor3 = (rawget(_G,"SirenxThemeText") or GuiConfig.TextColor)
        TextLabel2.TextSize = 13
        TextLabel2.Text = NotifyConfig.Content
        TextLabel2.TextXAlignment = Enum.TextXAlignment.Left
        TextLabel2.TextYAlignment = Enum.TextYAlignment.Top
        TextLabel2.BackgroundColor3 = (rawget(_G,"SirenxThemePanel") or GuiConfig.TextColor)
        TextLabel2.BackgroundTransparency = 0.9990000128746033
        TextLabel2.TextColor3 = GuiConfig.SubTextColor
        TextLabel2.BorderColor3 = GuiConfig.BgColor
...
function sirenx(msg, delay, color, title, desc)
    return Sirenx:MakeNotify({
        Title = title or "AegisHUB",
        Description = desc or "Notification",
        Content = msg or "Content",
        Color = color or GuiConfig.Accent2,
        Delay = delay or 4
    })
end
...
function Sirenx:Window(GuiConfig)
    ...
    -- ============================================================
    -- BLUE THEME (Optimized defaults)
    -- ============================================================
    local THEME = {
    -- Neon Blue Palette
    Accent  = Color3.fromRGB(0, 195, 255),   -- neon blue
    Accent2 = Color3.fromRGB(0, 255, 255),   -- cyan glow
    Bg      = Color3.fromRGB(5, 8, 18),      -- deep navy
    Panel   = Color3.fromRGB(10, 16, 32),    -- blue-black panel
    Stroke  = Color3.fromRGB(0, 255, 255),   -- neon stroke
    Text    = Color3.fromRGB(235, 245, 255), -- cool white
    SubText = Color3.fromRGB(160, 190, 220), -- desaturated cyan
}

    -- Accent / primary
    GuiConfig.Color        = GuiConfig.Color or THEME.Accent
    GuiConfig.Accent2      = GuiConfig.Accent2 or THEME.Accent2
    -- Optional extended palette
    GuiConfig.BgColor      = GuiConfig.BgColor or THEME.Bg
    GuiConfig.PanelColor   = GuiConfig.PanelColor or THEME.Panel
    GuiConfig.StrokeColor  = GuiConfig.StrokeColor or THEME.Stroke
    GuiConfig.TextColor    = GuiConfig.TextColor or THEME.Text
    GuiConfig.SubTextColor = GuiConfig.SubTextColor or THEME.SubText
    _G.SirenxThemeColor = GuiConfig.Color
    _G.SirenxThemeAccent2 = GuiConfig.Accent2
    _G.SirenxThemeBg = GuiConfig.BgColor
    _G.SirenxThemePanel = GuiConfig.PanelColor
    _G.SirenxThemeText = GuiConfig.TextColor
    ...
    local Sirenex = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    Sirenex.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    Sirenex.Name = "Sirenex"
    Sirenex.ResetOnSpawn = false
    Sirenex.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = Sirenex

    DropShadowHolder.Position = UDim2.new(0, (Sirenex.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (Sirenex.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    DropShadow.Image = "rbxassetid://6015897843"
    DropShadow.ImageColor3 = GuiConfig.PanelColor
    ...
    if GuiConfig.Theme then
        ...
        Main.BackgroundColor3 = GuiConfig.BgColor
        Main.BackgroundTransparency = 0
    end

    Main.AnchorPoint = Vector2.new(0.5, 0.5)
    Main.BorderColor3 = GuiConfig.BgColor
    ...
    Top.BackgroundColor3 = GuiConfig.BgColor
    Top.BackgroundTransparency = 0.9990000128746033
    Top.BorderColor3 = GuiConfig.BgColor
    Top.BorderSizePixel = 0
    ...
    TextLabel.TextSize = 14
    TextLabel.TextXAlignment = Enum.TextXAlignment.Left
    TextLabel.BackgroundColor3 = GuiConfig.PanelColor
    TextLabel.BackgroundTransparency = 0.9990000128746033
    TextLabel.BorderColor3 = GuiConfig.BgColor
    TextLabel.BorderSizePixel = 0
    ...
    TextLabel1.TextSize = 14
    TextLabel1.TextXAlignment = Enum.TextXAlignment.Left
    TextLabel1.BackgroundColor3 = GuiConfig.PanelColor
    TextLabel1.BackgroundTransparency = 0.9990000128746033
    TextLabel1.BorderColor3 = GuiConfig.BgColor
    TextLabel1.BorderSizePixel = 0
    ...
    Close.TextSize = 14
    Close.AnchorPoint = Vector2.new(1, 0.5)
    Close.BackgroundColor3 = GuiConfig.PanelColor
    Close.BackgroundTransparency = 0.9990000128746033
    Close.BorderColor3 = GuiConfig.BgColor
    Close.BorderSizePixel = 0
    ...
    ImageLabel1.BackgroundColor3 = GuiConfig.PanelColor
    ImageLabel1.BackgroundTransparency = 0.9990000128746033
    ImageLabel1.BorderColor3 = GuiConfig.BgColor
    ...
    Min.Text = ""
    Min.TextColor3 = GuiConfig.BgColor
    Min.TextSize = 14
    Min.AnchorPoint = Vector2.new(1, 0.5)
    Min.BackgroundColor3 = GuiConfig.PanelColor
    Min.BackgroundTransparency = 0.9990000128746033
    Min.BorderColor3 = GuiConfig.BgColor
    ...
    ImageLabel2.BackgroundColor3 = GuiConfig.PanelColor
    ImageLabel2.BackgroundTransparency = 0.9990000128746033
    ImageLabel2.ImageTransparency = 0.2
    ImageLabel2.BorderColor3 = GuiConfig.BgColor
    ImageLabel2.BorderSizePixel = 0
    ImageLabel2.Position = UDim2.new(0.5, 0, 0.5, 0)
    ImageLabel2.Size = UDim2.new(1, -9, 1, -9)
    ImageLabel2.Parent = Min

    LayersTab.BackgroundColor3 = GuiConfig.PanelColor
    LayersTab.BackgroundTransparency = 0.9990000128746033
    LayersTab.BorderColor3 = GuiConfig.BgColor
    ...
    DecideFrame.BackgroundColor3 = GuiConfig.PanelColor
    DecideFrame.BackgroundTransparency = 0.85
    DecideFrame.BorderColor3 = GuiConfig.BgColor
    ...
    Layers.BackgroundColor3 = GuiConfig.PanelColor
    Layers.BackgroundTransparency = 0.9990000128746033
    Layers.BorderColor3 = GuiConfig.BgColor
    ...
    NameTab.Text = ""
    NameTab.TextColor3 = GuiConfig.TextColor
    NameTab.TextSize = 24
    NameTab.TextWrapped = true
    NameTab.TextXAlignment = Enum.TextXAlignment.Left
    NameTab.BackgroundColor3 = GuiConfig.PanelColor
    NameTab.BackgroundTransparency = 0.9990000128746033
    NameTab.BorderColor3 = GuiConfig.BgColor
    ...
    LayersReal.BackgroundColor3 = GuiConfig.PanelColor
    LayersReal.BackgroundTransparency = 0.9990000128746033
    LayersReal.BorderColor3 = GuiConfig.BgColor
    ...
    ScrollTab.ScrollBarImageColor3 = GuiConfig.BgColor
    ScrollTab.ScrollBarThickness = 0
    ScrollTab.Active = true
    ScrollTab.BackgroundColor3 = GuiConfig.PanelColor
    ScrollTab.BackgroundTransparency = 0.9990000128746033
    ScrollTab.BorderColor3 = GuiConfig.BgColor
    ...
    -- Optimized CanvasSize updater (no expensive child loops)
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("Sirenex") then
            Sirenex:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Overlay.BackgroundColor3 = GuiConfig.BgColor
        ...
        DialogGlow.BackgroundColor3 = GuiConfig.PanelColor
        ...
        Gradient.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0, GuiConfig.Accent2),
            ColorSequenceKeypoint.new(0.25, GuiConfig.TextColor),
            ColorSequenceKeypoint.new(0.5, GuiConfig.Color),
            ColorSequenceKeypoint.new(0.75, GuiConfig.TextColor),
            ColorSequenceKeypoint.new(1.0, GuiConfig.Accent2)
        })
        ...
        Message.TextSize = 14
        Message.TextColor3 = GuiConfig.TextColor
        ...
        Yes.BackgroundColor3 = GuiConfig.PanelColor
        Yes.BackgroundTransparency = 0.935
        Yes.Text = "Yes"
        Yes.Font = Enum.Font.GothamBold
        Yes.TextSize = 15
        Yes.TextColor3 = GuiConfig.TextColor
        ...
        Cancel.BackgroundColor3 = GuiConfig.PanelColor
        Cancel.BackgroundTransparency = 0.935
        Cancel.Text = "Cancel"
        Cancel.Font = Enum.Font.GothamBold
        Cancel.TextSize = 15
        Cancel.TextColor3 = GuiConfig.TextColor
        ...
        Yes.MouseButton1Click:Connect(function()
            if Sirenex then Sirenex:Destroy() end
    ...
    MoreBlur.BackgroundColor3 = GuiConfig.BgColor
    MoreBlur.BackgroundTransparency = 0.999
    MoreBlur.BorderColor3 = GuiConfig.BgColor
    ...
    DropShadow1.ImageColor3 = GuiConfig.BgColor
    ...
    ConnectButton.Text = ""
    ConnectButton.TextColor3 = GuiConfig.BgColor
    ConnectButton.TextSize = 14
    ConnectButton.BackgroundColor3 = GuiConfig.PanelColor
    ConnectButton.BackgroundTransparency = 0.999
    ConnectButton.BorderColor3 = GuiConfig.BgColor
    ...
    DropdownSelect.BackgroundColor3 = GuiConfig.PanelColor
    DropdownSelect.BorderColor3 = GuiConfig.BgColor
    ...
    DropdownSelectReal.BackgroundColor3 = GuiConfig.PanelColor
    DropdownSelectReal.BackgroundTransparency = 0.7
    DropdownSelectReal.BorderColor3 = GuiConfig.BgColor
    ...
    function Tabs:AddTab(TabConfig)
        ...
        ScrolLayers.ScrollBarImageColor3 = GuiConfig.StrokeColor
        ScrolLayers.ScrollBarThickness = 0
        ScrolLayers.Active = true
        ScrolLayers.LayoutOrder = CountTab
        ScrolLayers.BackgroundColor3 = GuiConfig.PanelColor
        ScrolLayers.BackgroundTransparency = 0.9990000128746033
        ScrolLayers.BorderColor3 = GuiConfig.BgColor
        ...
        TabButton.Text = ""
        TabButton.TextColor3 = GuiConfig.TextColor
        TabButton.TextSize = 13
        TabButton.TextXAlignment = Enum.TextXAlignment.Left
        TabButton.BackgroundColor3 = GuiConfig.PanelColor
        TabButton.BackgroundTransparency = 0.9990000128746033
        TabButton.BorderColor3 = GuiConfig.BgColor
        ...
        TabName.TextColor3 = GuiConfig.TextColor
        TabName.TextSize = 13
        TabName.TextXAlignment = Enum.TextXAlignment.Left
        TabName.BackgroundColor3 = GuiConfig.PanelColor
        TabName.BackgroundTransparency = 0.9990000128746033
        TabName.BorderColor3 = GuiConfig.BgColor
        ...
        FeatureImg.BackgroundColor3 = GuiConfig.PanelColor
        FeatureImg.BackgroundTransparency = 0.9990000128746033
        FeatureImg.BorderColor3 = GuiConfig.BgColor
        ...
        if CountTab == 0 then
            ...
            ChooseFrame.BorderColor3 = GuiConfig.BgColor
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            Section.BackgroundColor3 = GuiConfig.PanelColor
            Section.BackgroundTransparency = 0.9990000128746033
            Section.BorderColor3 = GuiConfig.BgColor
            ...
            SectionReal.BackgroundColor3 = GuiConfig.PanelColor
            SectionReal.BackgroundTransparency = 0.9350000023841858
            SectionReal.BorderColor3 = GuiConfig.BgColor
            ...
            SectionButton.Text = ""
            SectionButton.TextColor3 = GuiConfig.BgColor
            SectionButton.TextSize = 14
            SectionButton.BackgroundColor3 = GuiConfig.PanelColor
            SectionButton.BackgroundTransparency = 0.9990000128746033
            SectionButton.BorderColor3 = GuiConfig.BgColor
            ...
            FeatureFrame.BackgroundColor3 = GuiConfig.BgColor
            FeatureFrame.BackgroundTransparency = 0.9990000128746033
            FeatureFrame.BorderColor3 = GuiConfig.BgColor
            ...
            SectionTitle.TextColor3 = GuiConfig.TextColor
            SectionTitle.TextSize = 13
            SectionTitle.TextXAlignment = Enum.TextXAlignment.Left
            SectionTitle.TextYAlignment = Enum.TextYAlignment.Top
            SectionTitle.AnchorPoint = Vector2.new(0, 0.5)
            SectionTitle.BackgroundColor3 = GuiConfig.PanelColor
            SectionTitle.BackgroundTransparency = 0.9990000128746033
            SectionTitle.BorderColor3 = GuiConfig.BgColor
            ...
            SectionDecideFrame.BackgroundColor3 = GuiConfig.PanelColor
            SectionDecideFrame.BorderColor3 = GuiConfig.BgColor
            ...
            UIGradient.Color = ColorSequence.new {
                ColorSequenceKeypoint.new(0, GuiConfig.PanelColor),
                ColorSequenceKeypoint.new(0.5, GuiConfig.Color),
                ColorSequenceKeypoint.new(1, GuiConfig.PanelColor)
            }
            ...
            SectionAdd.BackgroundColor3 = GuiConfig.PanelColor
            SectionAdd.BackgroundTransparency = 0.9990000128746033
            SectionAdd.BorderColor3 = GuiConfig.BgColor
            ...
            function Items:AddParagraph(ParagraphConfig)
                ...
                Paragraph.BackgroundColor3 = GuiConfig.PanelColor
                ...
                ParagraphTitle.TextColor3 = GuiConfig.TextColor
                ...
                ParagraphContent.TextColor3 = GuiConfig.TextColor
                ...
                if ParagraphConfig.ButtonText then
                    ...
                    ParagraphButton.BackgroundColor3 = GuiConfig.PanelColor
                    ...
                    ParagraphButton.TextColor3 = GuiConfig.TextColor
            ...
            function Items:AddPanel(PanelConfig)
                ...
                Panel.BackgroundColor3 = GuiConfig.PanelColor
                ...
                Content.TextSize = 12
                Content.TextColor3 = GuiConfig.TextColor
                ...
                if PanelConfig.Placeholder then
                    ...
                    InputFrame.BackgroundColor3 = GuiConfig.PanelColor
                    ...
                    InputBox.PlaceholderColor3 = GuiConfig.SubTextColor
                    InputBox.Text = PanelConfig.Default
                    InputBox.TextSize = 11
                    InputBox.TextColor3 = GuiConfig.TextColor
                ...
                ButtonMain.TextColor3 = GuiConfig.TextColor
                ButtonMain.TextSize = 12
                ButtonMain.TextTransparency = 0.3
                ButtonMain.BackgroundColor3 = GuiConfig.PanelColor
                ...
                if PanelConfig.SubButtonText then
                    ...
                    SubButton.TextColor3 = GuiConfig.TextColor
                    SubButton.TextSize = 12
                    SubButton.TextTransparency = 0.3
                    SubButton.BackgroundColor3 = GuiConfig.PanelColor
            ...
            function Items:AddButton(ButtonConfig)
                ...
                Button.BackgroundColor3 = GuiConfig.PanelColor
                ...
                MainButton.TextColor3 = GuiConfig.TextColor
                MainButton.TextTransparency = 0.3
                MainButton.BackgroundColor3 = GuiConfig.PanelColor
            ...
            function Items:AddToggle(ToggleConfig, Flag)
                ...
                Toggle.BackgroundColor3 = GuiConfig.PanelColor
                ...
                ToggleTitle.TextColor3 = GuiConfig.TextColor
                ...
                ToggleTitle2.TextColor3 = GuiConfig.TextColor
                ...
                ToggleContent.TextColor3 = GuiConfig.TextColor
                ...
                UIStroke8.Color = GuiConfig.StrokeColor
                UIStroke8.Thickness = 2
                UIStroke8.Transparency = 0.9
                UIStroke8.Parent = FeatureFrame2

                ToggleCircle.BackgroundColor3 = GuiConfig.TextColor
                ...
                function ToggleFunc:Set(Value)
                    ...
                    if Value then
                        ...
                        TweenService:Create(ToggleTitle, TweenInfo.new(0.2),
                            { TextColor3 = GuiConfig.TextColor }):Play()
                        ...
                        TweenService:Create(UIStroke8, TweenInfo.new(0.2),
                            { Color = GuiConfig.TextColor, Transparency = 0.9 }):Play()
                        TweenService:Create(FeatureFrame2, TweenInfo.new(0.2),
                            { BackgroundColor3 = GuiConfig.PanelColor, BackgroundTransparency = 0.92 }):Play()
                    end
                end
            ...
            function Items:AddSlider(SliderConfig, Flag)
                ...
                Slider.BackgroundColor3 = GuiConfig.PanelColor
                Slider.BackgroundTransparency = 0.9350000023841858
                Slider.BorderColor3 = GuiConfig.BgColor
                ...
                SliderTitle.TextColor3 = GuiConfig.TextColor
                SliderTitle.TextSize = 13
                SliderTitle.TextXAlignment = Enum.TextXAlignment.Left
                SliderTitle.TextYAlignment = Enum.TextYAlignment.Top
                SliderTitle.BackgroundColor3 = GuiConfig.PanelColor
                SliderTitle.BackgroundTransparency = 0.9990000128746033
                SliderTitle.BorderColor3 = GuiConfig.BgColor
                ...
                SliderContent.TextColor3 = GuiConfig.TextColor
                ...
                SliderContent.BackgroundColor3 = GuiConfig.PanelColor
                SliderContent.BackgroundTransparency = 0.9990000128746033
                SliderContent.BorderColor3 = GuiConfig.BgColor
                ...
                SliderInput.BorderColor3 = GuiConfig.BgColor
                ...
                TextBox.Text = "90"
                TextBox.TextColor3 = GuiConfig.TextColor
                TextBox.TextSize = 13
                TextBox.TextWrapped = true
                TextBox.BackgroundColor3 = GuiConfig.BgColor
                TextBox.BackgroundTransparency = 0.9990000128746033
                TextBox.BorderColor3 = GuiConfig.BgColor
                ...
                SliderFrame.BackgroundColor3 = GuiConfig.PanelColor
                SliderFrame.BackgroundTransparency = 0.800000011920929
                SliderFrame.BorderColor3 = GuiConfig.BgColor
                ...
                SliderDraggable.BorderColor3 = GuiConfig.BgColor
                ...
                SliderCircle.BorderColor3 = GuiConfig.BgColor
            ...
            function Items:AddInput(InputConfig, Flag)
                ...
                Input.BackgroundColor3 = GuiConfig.PanelColor
                Input.BackgroundTransparency = 0.9350000023841858
                Input.BorderColor3 = GuiConfig.BgColor
                ...
                InputTitle.TextColor3 = GuiConfig.TextColor
                InputTitle.TextSize = 13
                InputTitle.TextXAlignment = Enum.TextXAlignment.Left
                InputTitle.TextYAlignment = Enum.TextYAlignment.Top
                InputTitle.BackgroundColor3 = GuiConfig.PanelColor
                InputTitle.BackgroundTransparency = 0.9990000128746033
                InputTitle.BorderColor3 = GuiConfig.BgColor
                ...
                InputContent.TextColor3 = GuiConfig.TextColor
                ...
                InputContent.BackgroundColor3 = GuiConfig.PanelColor
                InputContent.BackgroundTransparency = 0.9990000128746033
                InputContent.BorderColor3 = GuiConfig.BgColor
                ...
                InputFrame.BorderColor3 = GuiConfig.BgColor
                ...
                InputTextBox.PlaceholderColor3 = GuiConfig.SubTextColor
                InputTextBox.PlaceholderText = "Input Here"
                InputTextBox.Text = InputConfig.Default
                InputTextBox.TextColor3 = GuiConfig.TextColor
                InputTextBox.TextSize = 12
                InputTextBox.TextXAlignment = Enum.TextXAlignment.Left
                InputTextBox.AnchorPoint = Vector2.new(0, 0.5)
                InputTextBox.BackgroundColor3 = GuiConfig.PanelColor
                InputTextBox.BackgroundTransparency = 0.9990000128746033
                InputTextBox.BorderColor3 = GuiConfig.BgColor
            ...
            function Items:AddDropdown(DropdownConfig, Flag)
                ...
                Dropdown.BackgroundColor3 = GuiConfig.PanelColor
                ...
                DropdownTitle.TextColor3 = GuiConfig.TextColor
                ...
                DropdownContent.TextColor3 = GuiConfig.TextColor
                ...
                OptionSelecting.TextColor3 = GuiConfig.TextColor
                ...
                OptionImg.ImageColor3 = GuiConfig.TextColor
                ...
                SearchBox.TextColor3 = GuiConfig.TextColor
                SearchBox.BackgroundColor3 = GuiConfig.PanelColor
                ...
                function DropdownFunc:AddOption(option)
                    ...
                    OptionText.TextColor3 = GuiConfig.TextColor
            ...
            function Items:AddDivider()
                ...
                Divider.BackgroundColor3 = GuiConfig.PanelColor
            ...
            function Items:AddSubSection(title)
                ...
                Background.BackgroundColor3 = GuiConfig.PanelColor
                ...
                Label.Text = "── [ " .. title .. " ] ──"
                Label.TextColor3 = GuiConfig.TextColor
                Label.TextSize = 12
